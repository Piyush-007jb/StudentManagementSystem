...
public class ViewAllStudents extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String name, branch, mobileno, gender;
        try
            (
                Connection con = dbconnection.DbConnection.getConnect();
                PreparedStatement ps = con.prepareStatement("Select * from crud where module = 'student'");
            ...
            while(rs.next())               
                    {
                        ...
                        Object[] o  = {name, branch,mobileno,gender};
                        dtm.addRow(o);
                    }
        } 
